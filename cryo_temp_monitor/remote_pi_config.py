"""
Config file for remote raspberry pi machine used for temperature logging of the Oxford Instruments cryostat.
"""
...
pi_config = dict(
    ...
    temp_dir_params = {'REMOTE_DIR':'/home/jimmy-neutron/Cryo_recording/2026',
                       'LOCAL_DIR':os.path.join(os.getcwd(),'cryo_cool_down'),
                       'LOCAL_FOLDER_YEAR_NAME':f'{datetime.now().year}',
                       'fname':'20260402_cool_down'},
